with base as (
    ...
    select * 
    from {{ ref('tmp_shopify__abandoned_checkout_shipping_line') }}
),
    ...
    select
        {{
            fivetran_utils.fill_staging_columns(
                source_columns=adapter.get_columns_in_relation(ref('tmp_shopify__abandoned_checkout_shipping_line')),
