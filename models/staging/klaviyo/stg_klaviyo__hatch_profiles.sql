{{
	config(
		alias = "stg_klaviyo__hatch_profiles"
	)
}}

WITH stg_klaviyo__hatch_profiles AS
(
	SELECT 
		ID,
		...
		ATTRIBUTES:location:latitude::float AS Latitude,
		ATTRIBUTES:location:longitude::float AS Longitude,
	...
	ATTRIBUTES:properties:due_date::STRING AS DUE_Date,
	CASE
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'MM/DD/YYYY') IS NOT NULL AND YEAR(TRY_TO_DATE(ATTRIBUTES:properties:due_date::STRING,
			'MM/DD/YYYY')) > 1000 THEN TRY_TO_DATE(ATTRIBUTES:properties:due_date::STRING,
			'MM/DD/YYYY')
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'YYYY/MM/DD') IS NOT NULL AND YEAR(TRY_TO_DATE(ATTRIBUTES:properties:due_date::STRING,
			'YYYY/MM/DD')) > 1000 THEN TRY_TO_DATE(ATTRIBUTES:properties:due_date::STRING,
			'YYYY/MM/DD')
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DD') IS NOT NULL AND YEAR(TRY_TO_DATE(ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DD')) > 1000 THEN TRY_TO_DATE(ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DD')
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'MM/DD/YYYY HH:MI:SS') IS NOT NULL AND YEAR(TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'MM/DD/YYYY HH:MI:SS')) > 1000 THEN TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'MM/DD/YYYY HH:MI:SS')
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'YYYY/MM/DD HH:MI:SS') IS NOT NULL AND YEAR(TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'YYYY/MM/DD HH:MI:SS')) > 1000 THEN TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'YYYY/MM/DD HH:MI:SS')
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DDTHH:MI:SS') IS NOT NULL AND YEAR(TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DDTHH:MI:SS')) > 1000 THEN TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DDTHH:MI:SS')
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'MM-DD-YYYY') IS NOT NULL AND YEAR(TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'MM-DD-YYYY')) > 1000 THEN TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'MM-DD-YYYY')
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'MM-DD-YY') IS NOT NULL AND YEAR(TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'MM-DD-YYYY')) > 1000 THEN TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'MM-DD-YYYY')
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DDTHH:MI:SSZ') IS NOT NULL AND YEAR(TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DDTHH:MI:SSZ')) > 1000 THEN TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DDTHH:MI:SSZ')
			WHEN TRY_TO_DATE(LEFT(ATTRIBUTES:properties:due_date::STRING,
			10),
			'YYYY-MM-DD') IS NOT NULL AND YEAR(TRY_TO_DATE( LEFT(ATTRIBUTES:properties:due_date::STRING,
			10),
			'YYYY-MM-DD')) > 1000 THEN TRY_TO_DATE( LEFT(ATTRIBUTES:properties:due_date::STRING,
			10),
			'YYYY-MM-DD')
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'MM/DD/YYYY') IS NOT NULL AND YEAR(TRY_TO_DATE(ATTRIBUTES:properties:due_date::STRING,
			'MM/DD/YYYY')) < 1000 THEN DATEADD( year,2000, TRY_TO_DATE(ATTRIBUTES:properties:due_date::STRING,
			'MM/DD/YYYY'))
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'YYYY/MM/DD') IS NOT NULL AND YEAR(TRY_TO_DATE(ATTRIBUTES:properties:due_date::STRING,
			'YYYY/MM/DD')) < 1000 THEN DATEADD( year,2000, TRY_TO_DATE(ATTRIBUTES:properties:due_date::STRING,
			'YYYY/MM/DD'))
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DD') IS NOT NULL AND YEAR(TRY_TO_DATE(ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DD')) < 1000 THEN DATEADD( year,2000, TRY_TO_DATE(ATTRIBUTES:properties:due_date::STRING,
			...
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'MM/DD/YYYY HH:MI:SS') IS NOT NULL AND YEAR(TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'MM/DD/YYYY HH:MI:SS')) < 1000 THEN DATEADD( year,2000, TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'MM/DD/YYYY HH:MI:SS'))
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'YYYY/MM/DD HH:MI:SS') IS NOT NULL AND YEAR(TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'YYYY/MM/DD HH:MI:SS')) < 1000 THEN DATEADD( year,2000, TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'YYYY/MM/DD HH:MI:SS'))
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DDTHH:MI:SS') IS NOT NULL AND YEAR(TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DDTHH:MI:SS')) < 1000 THEN DATEADD( year,2000, TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DDTHH:MI:SS'))
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'MM-DD-YYYY') IS NOT NULL AND YEAR(TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'MM-DD-YYYY')) < 1000 THEN DATEADD( year,2000, TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			...
			WHEN TRY_TO_TIMESTAMP(ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DDTHH:MI:SSZ') IS NOT NULL AND YEAR(TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DDTHH:MI:SSZ')) < 1000 THEN DATEADD( year,2000, TRY_TO_DATE( ATTRIBUTES:properties:due_date::STRING,
			'YYYY-MM-DDTHH:MI:SSZ'))
			WHEN TRY_TO_DATE(LEFT(ATTRIBUTES:properties:due_date::STRING,
			10),
			'YYYY-MM-DD') IS NOT NULL AND YEAR(TRY_TO_DATE( LEFT(ATTRIBUTES:properties:due_date::STRING,
			10),
			'YYYY-MM-DD')) < 1000 THEN DATEADD( year,2000, TRY_TO_DATE( LEFT(ATTRIBUTES:properties:due_date::STRING,
			10),
			'YYYY-MM-DD'))
			ELSE NULL END AS Formatted_Due_Date,
			'klaviyo_hatch' AS SOURCE_RELATION
	FROM {{ source("raw_klaviyo__hatch", "profiles") }}

)

SELECT * FROM stg_klaviyo__hatch_profiles
