...
WHERE SOURCE_RELATION = 'shopify_hatch'
GROUP BY EMAIL
),
...
FROM {{ref("int_klaviyo__hatch_profiles")}}
...
AND SOURCE_RELATION = 'shopify_hatch'
),
...
SELECT 
    ...
    INITCAP(COALESCE(B.BILLING_ADDRESS_COUNTRY, A.COUNTRY)) AS COUNTRY,
...
final_data AS (
	...
	CASE WHEN  CREATED_DATE >= '2022-12-20' OR Last_ORDER_DATE >= '2022-12-20' THEN 1 ELSE 0 END AS Sellable
